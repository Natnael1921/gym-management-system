...
const MemberAttendance = () => {
  ...
  if (loading) {
    return (
      <div className="member-attendance-page">
        <Sidebar role="member" />
        <div className="dashboard-content member-loading">
  ...
  return (
    <div className="member-attendance-page">
      ...
      <div className="dashboard-content member-attendance">
        <h1>Attendance</h1>

        <div className="member-attendance-top">
        ...
        <div className="member-week-grid">
          {weekDays.map((d) => {
